...
public class ancientChestBlockEntity extends RandomizableContainerBlockEntity {
    private NonNullList<ItemStack> items = NonNullList.withSize(27, ItemStack.EMPTY);
    private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
        protected void onOpen(Level p_155062_, BlockPos p_155063_, BlockState p_155064_) {
            ancientChestBlockEntity.this.playSound(p_155064_, ModSounds.SCRAPE.get());
            ancientChestBlockEntity.this.updateBlockState(p_155064_, true);
        }

        protected void onClose(Level p_155072_, BlockPos p_155073_, BlockState p_155074_) {
            ancientChestBlockEntity.this.playSound(p_155074_, ModSounds.SCRAPE.get());
            ancientChestBlockEntity.this.updateBlockState(p_155074_, false);
        }
        ...
        protected boolean isOwnContainer(Player p_155060_) {
            if (p_155060_.containerMenu instanceof ChestMenu) {
                ...
                return container == ancientChestBlockEntity.this;
            } else {
                return false;
            }
        }
    ...
    public ancientChestBlockEntity(BlockPos p_155052_, BlockState p_155053_) {
        super(ModBlockEntities.ANCIENT_CHEST.get(), p_155052_, p_155053_);
    }
    ...
    protected Component getDefaultName() {
        return Component.translatable("block.cavernsofchaos.ancient_chest");
    }
    ...
    private void updateBlockState(BlockState p_58607_, boolean p_58608_) {
        this.level.setBlock(this.getBlockPos(), p_58607_.setValue(ancientChestBlock.OPEN, Boolean.valueOf(p_58608_)), 3);
    }

    private void playSound(BlockState p_58601_, SoundEvent p_58602_) {
        Vec3i vec3i = p_58601_.getValue(ancientChestBlock.FACING).getNormal();
