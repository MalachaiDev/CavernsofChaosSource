...
public class CaveSlimeOuterlayer <T extends LivingEntity> extends RenderLayer<T, CaveSlimeModel<T>> {
    private final EntityModel<T> model;

    public CaveSlimeOuterlayer(RenderLayerParent<T, CaveSlimeModel<T>> pRenderer, EntityModelSet pModelSet) {
        super(pRenderer);
        this.model = new CaveSlimeModel<>(pModelSet.bakeLayer(ModModelLayers.CAVESLIME_OUTER));
    }
